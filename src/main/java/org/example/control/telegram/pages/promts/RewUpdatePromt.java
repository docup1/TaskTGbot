...
public class RewUpdatePromt implements PageLogicInterface {
    public SendMessage generate(SendMessage message, long chatId, String userName, String args) {
        message.setText("Напишите вознаграждение за выполнение задачи:");

        DopTextTracker.SetArgsNeded(chatId, "SETREW-WAITING_" + args);
