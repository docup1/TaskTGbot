...
public class TitleUpdatePromt implements PageLogicInterface {
    public SendMessage generate(SendMessage message, long chatId, String userName, String args) {
        message.setText("Напишите новое название задачи:");

        DopTextTracker.SetArgsNeded(chatId, "SETTITLE-WAITING_" + args);
