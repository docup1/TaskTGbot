...
public class ShowFinishedTasks implements PageLogicInterface {
        public SendMessage generate(SendMessage message, long chatId, String userName, String args) {
                ...
                var res = CommandManager.execute(CommandsNames.MY_TASKS, new ArrayList<>(Arrays.asList(userID, "completed")));
                ...
                for (int i = 0; i < taskList.size(); i++) {
                        ...
                        taskButton.setCallbackData("TASK-TO-SHOW_completed " + (i + 1));  // CallbackData для обработки выбранной задачи
                        buttons.add(Collections.singletonList(taskButton));
                }

                // Устанавливаем Inline клавиатуру
                markup.setKeyboard(buttons);
                message.setText("Список выполненных для вас задач:");
